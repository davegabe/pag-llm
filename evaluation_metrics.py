...
class BackwardInferenceEvaluator:
    ...
    def __init__(self, forward_model: BaseLMModel, external_llm: str):
        """
    ...
    def compute_comprehensive_metrics(self,
        ...
        ppl_metrics = self.compute_third_party_perplexity(
            predicted_overall_text, original_overall_text
        )
    ...
    def compute_third_party_perplexity(self, predicted_text: str, original_text: str) -> Dict[str, float]:
        """
        ...
        return {
            'predicted_perplexity': predicted_ppl,
