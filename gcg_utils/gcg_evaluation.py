...
class GCGResult:
    ...
    """
    Attack input IDs, which are the tokens generated by the GCG algorithm.
    """
    x_attack_ids: list[int]
    ...
    def to_dict(self) -> dict[str, list[int] | int]:
        ...
        return {
            ...
            'x_attack_ids': self.x_attack_ids,
    ...
    def from_dict(data: dict[str, Any]) -> 'GCGResult':
        ...
        return GCGResult(
            ...
            x_attack_ids=data['x_attack_ids'],
...
def evaluate_model_with_gcg(gcg: GCGAlgorithm,
    ...
    for sample_idx in tqdm(samples_to_attack, desc="Evaluating with GCG"):
        ...
        # Run the attack
        x_attack_ids, y_response_ids, _, _, steps = gcg.tokenize_and_attack(tokenizer, model, None, target_response_str)
        ...
        attacks.append(GCGResult(
            ...
            x_attack_ids=x_attack_ids.detach().cpu().tolist(),
