...
python eval_gcg.py --config-name pag-identity-small-offline training.method=val-identity-grad +model.checkpoint_path=best-checkpoints/best-val-identity.ckpt
