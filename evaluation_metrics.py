...
class BackwardInferenceEvaluator:
    ...
    def __init__(self, forward_model: BaseLMModel):
        """
    ...
    def compute_comprehensive_metrics(self,
                                    ...
                                    generated_prefix: torch.Tensor, 
                                    true_suffix: torch.Tensor,
                                    reference_prefix_mask: torch.Tensor = None,
                                    generated_prefix_mask: torch.Tensor = None,
                                    suffix_mask: torch.Tensor = None) -> Dict[str, Any]:
        """
